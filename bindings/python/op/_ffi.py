...
def _bind(dll: ctypes.WinDLL) -> ctypes.WinDLL:
    ...
    signatures = [
        ...
        ("OpGetScreenWidth", c_int, [op_handle]),
        ("OpGetScreenHeight", c_int, [op_handle]),
        ("OpGetScreenDepth", c_int, [op_handle]),
        ("OpGetDPI", c_int, [op_handle]),
        ("OpGetTime", c_wchar_p, [op_handle]),
        ("OpBeep", c_int, [op_handle, c_int, c_int]),
        ("OpGetRandomNumber", c_int, [op_handle, c_int, c_int]),
        ("OpGetRandomDouble", c_double, [op_handle, c_double, c_double]),
        ("OpGaiLu", c_int, [op_handle, c_int]),
        ("OpGetMachineCode", c_wchar_p, [op_handle]),
        ("OpIsElevated", c_int, [op_handle]),
        ("OpLockWindowPosition", c_int, [op_handle, intptr_t, c_int]),
        ("OpLockWindowSize", c_int, [op_handle, intptr_t, c_int]),
        ("OpDisableMinMax", c_int, [op_handle, intptr_t, c_int]),
        ("OpSetIme", c_int, [op_handle, intptr_t, c_int]),
        ("OpGetFPS", c_int, [op_handle]),
        ("OpDownCpu", c_int, [op_handle, c_int, c_int]),
        ...
        ("OpSetDxAttr", c_int, [op_handle, c_int, c_int]),
        ("OpGetDxAttr", c_int, [op_handle]),
        ...
        ("OpSetBinaryPreprocess", c_int, [op_handle, c_int, c_int, c_int, c_int]),
        ("OpGetBinaryPreprocess", c_int, [op_handle, c_int_p, c_int_p, c_int_p, c_int_p]),
        ("OpFetchWord", c_wchar_p, [op_handle, c_int, c_int, c_int, c_int, c_wchar_p, c_wchar_p]),
        ("OpFetchWordEx", c_wchar_p, [op_handle, c_int, c_int, c_int, c_int, c_wchar_p, c_double, c_wchar_p]),
        ("OpExtractWordRects", c_wchar_p, [op_handle, c_int, c_int, c_int, c_int, c_wchar_p, c_double, c_int]),
        (
            "OpExtractWordRectsEx",
            c_wchar_p,
            [op_handle, c_int, c_int, c_int, c_int, c_wchar_p, c_double, c_int, c_int, c_int],
        ),
        ("OpFetchWords", c_wchar_p, [op_handle, c_int, c_int, c_int, c_int, c_wchar_p, c_double, c_wchar_p, c_int]),
        (
            "OpFetchWordsEx",
            c_wchar_p,
            [op_handle, c_int, c_int, c_int, c_int, c_wchar_p, c_double, c_wchar_p, c_int, c_int, c_int],
        ),
        (
            "OpFetchWordsByRects",
            c_wchar_p,
            [op_handle, c_int, c_int, c_int, c_int, c_wchar_p, c_double, c_wchar_p, c_wchar_p],
        ),
        ("OpGetBinaryPreview", c_wchar_p, [op_handle, c_int, c_int, c_int, c_int, c_wchar_p, c_double, c_int_p]),
        ("OpGetWordPreview", c_wchar_p, [op_handle, c_wchar_p, c_int_p]),
        ("OpCheckWordDict", c_wchar_p, [op_handle, c_wchar_p, c_int_p]),
        ("OpNormalizeWordDict", c_wchar_p, [op_handle, c_wchar_p, c_int_p]),
        ("OpRenameWordDict", c_wchar_p, [op_handle, c_wchar_p, c_wchar_p, c_int_p]),
