...
TesseractOcr::TesseractOcr() : m_api(nullptr) {
...
int TesseractOcr::init() {
    ...
    if (m_api->Init(_ws2string(RuntimeEnvironment::getBasePath() + L"/tess_model").c_str(), "chi_sim")) {
...
int TesseractOcr::ocr(byte *data, int w, int h, int bpp, vocr_rec_t &result) {
